...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            <form action="/home/account/changePassword" method="post">

                <div class="form-group">
                    <label for="passOld">PassWord</label>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" required name="passNew" id="passNew"
                           value="" placeholder="Enter ">
                </div>
