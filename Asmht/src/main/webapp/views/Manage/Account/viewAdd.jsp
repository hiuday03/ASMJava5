                            ...
                            <form action="/admin/accounts/add" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required name="fullname" id="fullname"
                                           placeholder="Enter fullname" value="${account.fullname}">
                                </div>
                                <div class="form-group">
...
<%--                                           placeholder="Enter photo URL" value="${account.photo}">--%>
<%--                                </div>--%>
<%--                                <div class="form-group">--%>
...
<%--                                               <c:if test="${!account.active}">checked</c:if> onclick="handleCheckbox1(this)">--%>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="admin" name="admin" value="true"
                                               <c:if test="${account.admin}">checked</c:if> onclick="handleCheckbox(this)">
                                        <label class="form-check-label" for="admin">
                                            Admin
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" id="customer" name="admin" value="false"
                                               <c:if test="${!account.admin}">checked</c:if> onclick="handleCheckbox(this)">
