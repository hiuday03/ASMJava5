    ...
    <div class="row gy-3">
        ...
        <div class="col-lg-9">
            <div class="row">
                ...
                <div class="container">
                    <h2 style="text-align: center">OderDetail</h2>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                        <c:forEach var="orderDetail" items="${listOrderDetail}" varStatus="status">
                            <tr>
                    ...
                    <%--        <a href="/admin/orderDetails?p=0" class="${page.first ? 'disabled' : ''}">First</a>--%>
                    <%--        <a href="/admin/orderDetails?p=${page.number - 1}" class="${page.first ? 'disabled' : ''}">Previous</a>--%>

                    <%--        <c:forEach begin="0" end="${page.totalPages - 1}" var="i">--%>
                    <%--            <a href="/admin/orderDetails?p=${i}" class="${i == page.number ? 'active' : ''}">${i + 1}</a>--%>
                    <%--        </c:forEach>--%>

                    <%--        <a href="/admin/orderDetails?p=${page.number + 1}" class="${page.last ? 'disabled' : ''}">Next</a>--%>
                    <%--        <a href="/admin/orderDetails?p=${page.totalPages - 1}" class="${page.last ? 'disabled' : ''}">Last</a>--%>
                    <%--    </div>--%>
                </div>
